...
def Plot_Brain_Graph_Signal(graph_signal, path_pos=path_pos, title=None, scale=1, node_colors=None, size_nodes_const=False, top_view=False, printscreen=None, movie=None):
    """ Brain graph signal on the Brain 3D plot
                        ...
                        scene=dict(camera=camera, 
                                   xaxis=dict(nticks=5, 
                                              ...
                                              #titlefont=dict(
                                                              ...
                                                              #size=40,
                                                              #color='#7f7f7f'), 
                                              tickfont=dict(size=14, color='black'), visible=False),
                                   yaxis=dict(nticks=7,
                                              #title='x', 
                                              #titlefont=dict(
                                                              #family='Courier New, monospace',
...
def Plot_Brain_Clusters(models_list, k_cluster, nodes_color, path_pos=path_pos, scale=1, title='Brain Clusters', top_view=False, movie=None, printscreen=None):
    ...
    for c in set(list(df['cluster'])):
        ...
        #df_low_sc = df_low_sc.append(df_temp.sort_values('sc').iloc[:n_lowest_sc])
                        ...
                        scene=dict(camera=camera, 
                                   ...
                                   zaxis=dict(nticks=7,
                                              ...
                                              #titlefont=dict(
                                                              ...
                                                              #size=40,
                                                              #color='#7f7f7f'), 
                                              tickfont=dict(size=16, color='black'), visible=False))
                        #xaxis=dict(
                        #    title='x Axis',
                        #    titlefont=dict(
                        #        family='Courier New, monospace',
    ...
    # need to fix the bar!!
    #fig.update_layout(autosize=False, width=800, height=800, margin=dict(l=50, r=50, b=50, t=50, pad=4))
